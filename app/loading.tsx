...
export default function HomeLoading() {
  return (
    <div className="min-h-screen bg-[#12111a] flex flex-col">
      ...
      {/* Hero skeleton */}
      <section className="bg-zinc-800 animate-pulse">
        <div className="max-w-6xl mx-auto px-4 py-24 text-center space-y-6">
          <div className="h-3 w-40 bg-zinc-700 rounded mx-auto" />
          <div className="space-y-3 max-w-2xl mx-auto">
            <div className="h-10 bg-zinc-700 rounded" />
            <div className="h-10 w-3/4 bg-zinc-700 rounded mx-auto" />
          </div>
          <div className="h-4 w-96 bg-zinc-700 rounded mx-auto" />
          <div className="flex items-center justify-center gap-3 pt-2">
            <div className="h-11 w-32 bg-zinc-600 rounded-xl" />
            <div className="h-11 w-36 bg-zinc-700 rounded-xl" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 pt-12 pb-4 w-full">
        <div className="h-5 w-40 bg-zinc-700 animate-pulse rounded mb-5" />
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-zinc-800">
              <div className="w-16 h-16 bg-zinc-700 animate-pulse rounded-full" />
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 space-y-8 w-full">
        <div className="flex items-center justify-between">
          <div className="h-7 w-48 bg-zinc-700 animate-pulse rounded" />
          <div className="h-4 w-20 bg-zinc-700 animate-pulse rounded" />
        </div>
