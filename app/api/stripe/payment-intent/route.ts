...
export async function POST(request: Request) {
  ...
  const idempotencyKey = `${user.id}_${tierId}_${eventId}_${quantity}_${fees.totalAmount}_${fees.applicationFeeAmountCentavos}_${organizer.stripe_account_id}_${Math.floor(nowSecs / 600)}`
