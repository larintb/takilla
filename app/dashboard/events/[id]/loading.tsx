  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="h-6 w-20 bg-zinc-800 animate-pulse rounded-full" />
      </div>

      {/* Event header card */}
      <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6 space-y-4">
        <div className="flex gap-5">
          <div className="w-24 h-24 bg-zinc-700 animate-pulse rounded-xl shrink-0" />
          <div className="flex-1 space-y-2">
            <div className="h-7 w-2/3 bg-zinc-700 animate-pulse rounded" />
        ...
        <div className="flex gap-3 pt-2 border-t border-zinc-800">
          ...
          <div className="h-9 w-28 bg-zinc-700 animate-pulse rounded-lg" />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {Array.from({ length: 2 }).map((_, i) => (
            <div key={i} className="bg-zinc-900 rounded-xl border border-zinc-800 px-5 py-4 flex items-center justify-between">
              <div className="space-y-1">
                <div className="h-5 w-28 bg-zinc-700 animate-pulse rounded" />
                <div className="h-3 w-36 bg-zinc-800 animate-pulse rounded" />
              </div>
