        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <div className="bg-zinc-900 rounded-2xl border border-zinc-800 overflow-hidden">
            ...
            <div className="flex gap-4 p-5 border-b border-zinc-800">
              <div className="w-16 h-16 rounded-xl bg-zinc-700 animate-pulse shrink-0" />
              <div className="flex-1 space-y-2 py-1">
                ...
                <div className="h-3 w-2/5 bg-zinc-800 animate-pulse rounded" />
              </div>
            </div>
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                <div className="h-5 w-12 bg-zinc-700 animate-pulse rounded" />
            ...
            <div className="px-5 pb-5 space-y-3">
              <div className="h-12 w-full bg-zinc-700 animate-pulse rounded-xl" />
              <div className="h-3 w-3/4 bg-zinc-800 animate-pulse rounded mx-auto" />
            </div>
          </div>
        </div>
    </main>
